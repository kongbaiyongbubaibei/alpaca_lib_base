...
class DragToActionLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : RelativeLayout(context, attrs) {
    ...
    init {
        ...
        totalDragDistance = DensityUtil.dip2px(context, DRAG_MAX_DISTANCE.toFloat())
    ...
    private fun initRefreshView() {
        ...
        headContainer = headerView.findViewById(R.id.head_container) as LinearLayout
        textView!!.text = "左\n滑\n更\n多"

    }

    public fun setStyle(background: Int, textColor: Int) {
        headContainer!!.setBackgroundResource(background)
        textView!!.setTextColor(textColor)
    }

    public fun setStyle(background: Int) {
        headContainer!!.setBackgroundColor(background)
    }
    ...
    companion object {
        ...
        val STYLE_SUN = 0
        val MAX_OFFSET_ANIMATION_DURATION = 10
