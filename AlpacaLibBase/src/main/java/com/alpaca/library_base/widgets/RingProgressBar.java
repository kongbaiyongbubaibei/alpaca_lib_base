...
public class RingProgressBar extends View {
  ...
  public RingProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    //初始化属性
    TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RingProgressBar1);

    ringColor = mTypedArray.getColor(R.styleable.RingProgressBar1_ringColor, Color.BLACK);
    ringProgressColor = mTypedArray.getColor(R.styleable.RingProgressBar1_ringProgressColor,
        Color.WHITE);
    textColor = mTypedArray.getColor(R.styleable.RingProgressBar1_textColor, Color.BLACK);
    textSize = mTypedArray.getDimension(R.styleable.RingProgressBar1_textSize, 16);
    ringWidth = mTypedArray.getDimension(R.styleable.RingProgressBar1_ringWidth, 5);
    max = mTypedArray.getInteger(R.styleable.RingProgressBar1_max_progress, 100);
    textIsShow = mTypedArray.getBoolean(R.styleable.RingProgressBar1_textIsShow, true);
    style = mTypedArray.getInt(R.styleable.RingProgressBar1_style, 0);
    progress = mTypedArray.getInteger(R.styleable.RingProgressBar1_progress, 0);
    padding = mTypedArray.getDimension(R.styleable.RingProgressBar1_ringPadding, 5);
