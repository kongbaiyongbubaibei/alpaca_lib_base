...
public class JzvdStd extends Jzvd {
    ...
    public void setUp(JZDataSource jzDataSource, int screen) {
        ...
        RelativeLayout.LayoutParams topLp = (RelativeLayout.LayoutParams) topContainer.getLayoutParams();
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            fullscreenButton.setImageResource(R.drawable.min_190805);
            ...
            topLp.height = DensityUtil.dip2px(getContext(), 60);
            topContainer.setPadding(DensityUtil.dip2px(getContext(), 10), DensityUtil.dip2px(getContext(), 12), DensityUtil.dip2px(getContext(), 10), 0);
        } else if (currentScreen == SCREEN_WINDOW_NORMAL) {
            fullscreenButton.setImageResource(R.drawable.max_190805);
            backButton.setVisibility(View.VISIBLE);
            tinyBackImageView.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (currentScreen == SCREEN_WINDOW_NORMAL) {
                if (MyActivityManager.getInstance().getCurrentActivity() instanceof MvpBaseActivity) {
                    ((MvpBaseActivity) MyActivityManager.getInstance().getCurrentActivity()).back();
                }
            } else {
                backPress();
            }
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        if (currentScreen == SCREEN_WINDOW_LIST) {
            if (thumbImg == View.VISIBLE) {
                startButton.setVisibility(INVISIBLE);
                rootContainer.setBackgroundColor(Color.parseColor("#00000000"));
            } else {
                startButton.setVisibility(startBtn);
                rootContainer.setBackgroundColor(Color.parseColor("#000000"));
            }
            btPlay.setVisibility(thumbImg);
        } else {
            startButton.setVisibility(startBtn);
            rootContainer.setBackgroundColor(Color.parseColor("#000000"));
            btPlay.setVisibility(GONE);
        }
    ...
    private void showSpeedChangeDialog(float speed) {
        ...
        float[] speedArr = {0.5f, 0.8f, 1.0f, 1.2f, 1.5f};
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                JZMediaManager.setSpeed(speedArr[i]);
            }
