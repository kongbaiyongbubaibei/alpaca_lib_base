...
public class SignCheck {
    ...
    private String pknm = null;
    private String realCer = null;
    private String realPkNm = null;
    ...
    public SignCheck(Context context, String realCer, String realPkNm) {
        this.context = context;
        this.realCer = realCer;
        this.realPkNm = realPkNm;
        this.cer = getCertificateSHA1Fingerprint();
        this.pknm = getPknm();
    ...
    public boolean check() {
        ...
        if (this.realCer != null) {
            if (this.realPkNm != null) {
                cer = cer.trim();
                pknm = pknm.trim();
                realPkNm = realPkNm.trim();
                realCer = realCer.trim();
                if (this.cer.equals(this.realCer) && this.pknm.equals(this.realPkNm)) {
                    return true;
                } else {
                    return false;
                }
