...
public class StatusBarUtil {
    ...
    public static void setMode(Activity activity, Boolean isLight, int color) {
        if (Build.VERSION.SDK_INT >= 23) {
            setMIUIStatusBarDarkIcon(activity, isLight);
            setMeizuStatusBarDarkIcon(activity, isLight);
